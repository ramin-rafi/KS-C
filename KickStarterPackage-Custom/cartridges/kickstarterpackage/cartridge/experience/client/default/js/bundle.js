...
! function (e) {
    ...
    Object.defineProperty(t, "__esModule", {
            value: !0
        }), t.Form = t.GooglePayEnv = t.ModalState = t.Selectors = t.Events = t.CardTypes = t.CardBrand = t.ComboCard = t.PaymentMethod = void 0,
        function (e) {
        ...
        }(t.ModalState || (t.ModalState = {})),
        function (e) {
            e.LIVE = "PRODUCTION", e.TEST = "TEST";
        }(t.GooglePayEnv || (t.GooglePayEnv = {})),
        function (e) {
    ...
    e.exports = function (e) {
        ...
        e.exports = function (e, t) {
            var n,
                ...
                f = e.global,
                y = e.stat;
            if (n = f ? r : y ? r[m] || c(m, {}) : (r[m] || {}).prototype)
                for (l in t) {
        ...
        function we(e, t, n, r, o, a, i, c, d, s) {
            ...
            for (d == le && (d = null != i ? i[0] : g ? be(r, 0) : null), n.__k = [], l = 0; l < t.length; l++) {
                if (null != (h = n.__k[l] = null == (h = t[l]) || "boolean" == typeof h ? null : "string" == typeof h || "number" == typeof h ? ye(null, h, null, null, h) : Array.isArray(h) ? ye(_e, {
                    ...
                    if (h.__ = n, h.__b = n.__b + 1, null === (p = _[l]) || p && h.key == p.key && h.type === p.type) _[l] = void 0;
                    else
                        for (u = 0; u < g; u++) {
        ...
        function Ne(e, t, n, r, o, a, i) {
            ...
            else if (o == n || a != i || null == a.parentNode) e: if (null == i || i.parentNode !== e) e.appendChild(a), c = null;
                else {
                    for (d = i, s = 0;
                        (d = d.nextSibling) && s < r.length; s += 2) {
                        if (d == a) break e;
                    }
        ...
        function Se(e, t, n, r, o, a, i, c, d) {
            ...
            try {
                e: if ("function" == typeof v) {
                    if (y = t.props, _ = (s = v.contextType) && r[s.__c], g = s ? _ ? _.props.value : s.__ : r, n.__c ? f = (l = t.__c = n.__c).__ = l.__E : ("prototype" in v && v.prototype.render ? t.__c = l = new v(y, g) : (t.__c = l = new ge(y, g), l.constructor = v, l.render = Oe), _ && _.sub(l), l.props = y, l.state || (l.state = {}), l.context = g, l.__n = r, u = l.__d = !0, l.__h = []), null == l.__s && (l.__s = l.state), null != v.getDerivedStateFromProps && (l.__s == l.state && (l.__s = he({}, l.__s)), he(l.__s, v.getDerivedStateFromProps(y, l.__s))), p = l.props, h = l.state, u) null == v.getDerivedStateFromProps && null != l.componentWillMount && l.componentWillMount(), null != l.componentDidMount && l.__h.push(l.componentDidMount);
                    else {
                        if (null == v.getDerivedStateFromProps && y !== p && null != l.componentWillReceiveProps && l.componentWillReceiveProps(y, g), !l.__e && null != l.shouldComponentUpdate && !1 === l.shouldComponentUpdate(y, l.__s, g) || t.__v === n.__v) {
                            l.props = y, l.state = l.__s, t.__v !== n.__v && (l.__d = !1), l.__v = t, t.__e = n.__e, t.__k = n.__k, l.__h.length && i.push(l),
                                function e(t, n, r) {
                                    var o, a;
        ...
        var vr = function (e) {
            ...
            return S(t, e), t.prototype.init = function () {
                ...
                yr(window, "message", this.postMessageListener, !1), this.iframeContentWindow = null,
                    function (e) {
                        for (; e.firstChild;) {
        ...
        function io(e) {
            ...
            if (e.supportedBrands && e.supportedBrands.length)
        ...
        function Ui(e) {
            ...
            return this.showValidation = function () {
                ...
                return t.setFocusOn = x.current.setFocusOn, t.updateStyles = x.current.updateStyles,
                    function () {
                        x.current.destroy();
                    };
            }, []), tt(function () {
        ...
        function $i(e) {
            ...
            tt(function () {
                var n = e.shouldRedirectOnMobile,
                    r = e.url,
                    o = window.matchMedia("(max-width: 768px)").matches && /Android|iPhone|iPod/.test(navigator.userAgent);
                return n && r && o ? t.redirectToApp(r, P) : P(),
                    function () {
                        clearTimeout(N);
                    };
            }, []), tt(function () {
